    ...
    <div className="py-3 sm:py-6 px-3 sm:px-4 lg:px-8 border-b border-border relative group/container" ref={containerRef}>
            ...
            return (
              ...
              >
                <div className="story-ring group-hover:scale-110 transition-transform duration-300">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-card border-2 sm:border-4 border-background flex items-center justify-center group-hover:rotate-6 transition-transform duration-300 overflow-hidden">
                    {/* Render high-quality icon with the brand color */}
                    <IconComponent
      ...
      {selectedSkill && (
        ...
        >
          ...
          >
            <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto mb-4 sm:mb-6 rounded-full bg-gradient-to-br from-primary/10 to-primary/20 flex items-center justify-center animate-bounce-subtle">
              {/* Render the icon inside the modal as well */}
              {(() => {
                const ModalIcon = selectedSkill.icon;
                return <ModalIcon className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14" style={{ color: selectedSkill.color }} />;
              })()}
            </div>
            ...
            <p className="mt-3 sm:mt-4 text-sm sm:text-base text-muted-foreground animate-slide-up" style={{ animationDelay: '0.15s' }}>
              Expertise in {selectedSkill.name}. Used in various projects and production environments.
            </p>
